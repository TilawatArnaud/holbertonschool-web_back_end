...
async def measure_runtime(n: int, max_delay: int) -> float:
    """Asynchronous coroutine that measures
    the runtime of multiple wait_n coroutines.
    ...
    Returns:
        float: The total runtime of the wait_n coroutines.
    """
